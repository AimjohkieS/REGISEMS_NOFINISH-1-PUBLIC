...
if(isset($_POST["submit"]))
{
     ...
     while(($filesop = fgetcsv($handle, 1500, ",")) !== false) {
         ...
         $sql = "insert into s_data (Student_id,StudentStatus,NameTitle,FirstName,LastName,Bechelor_Degrees,Phone,Faculty,Program,Major,Place,Student_type,Study_time,Education_system) values ('$ems_id','$ems_status','$ems_ntitle','$ems_first','$ems_last','$ems_Tel','$ems_BacDegree','$ems_faculty',' $ems_program',' $ems_major','$ems_place',' $ems_stype','$ems_stime','$ems_edu')";
         if ($c > 1 ) {
