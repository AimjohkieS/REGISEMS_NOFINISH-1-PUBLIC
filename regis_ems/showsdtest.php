...
<body>
    ...
    <div class="container">
        <div class="card mt-3">
            ...
            <div class="card-body col-md-10   " style="height: 800px;">    
                    <div class="row d-flex">
                        <div class="input-group col-4 ">
                            <div class="input-group-prepend">
                                <?php $txtsearch = $_POST['txtsearch'];
                            ...
                            $rowcount=mysqli_num_rows($result);
                              ...
                              print  "</center>" ;
                              print  "<BR>" ;
                              echo "<table border='1' width='150' height='50' >";
                             echo "<tr align='center' bgcolor='#CCCCCC'><TH> รหัสนักศึกษา</TH><TH> สถานภาพนักศึกษา </TH> <TH> คำนำหน้า </TH> <TH> ชื่อ </TH><TH> นามสกุล </TH><TH> โทรศัพท์ </TH><TH> ระดับการศึกษา </TH><TH> คณะ/โรงเรียน </TH><TH> หลักสูตร </TH><TH> สาขาวิชา </TH><TH> สถานที่จัดการเรียนการสอน </TH><TH> ประเภทนักศึกษา </TH><TH> เวลาจัดการเรียนการสอน </TH><TH> ระบบการศึกษา </TH><TH> เอกสารที่จัดส่ง </TH><TH> เลขพัสดุ </TH> <TH> วันที่จัดส่งเอกสาร </TH><TH> เวลาที่บันทึก </TH></TR>" ;
                  if ($rowcount >= 1){
