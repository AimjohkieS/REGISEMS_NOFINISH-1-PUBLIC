    ...
    <div class="container">
        <div class="card mt-3">
            ...
            <div class="card-body col-md-10 col-lg-8 col-xl-5 mx-auto   " style="height: 515px;">
                <form method="post" action="insertdt.php" class=" text-center mt-5 ">
                    ...
                    <div class="row d-flex">
                        <div class="input-group col-12 col-md-9 mb-2 mb-md-0">
                            <input type="text" class="form-control form-control-lg" name="search" placeholder="รหัสนักศึกษา">
...
<!--             <div class="card-body"  style="font-family: 'Kanit', sans-serif;">
              ...
              <form method="post" action="insertdt.php">
                        <div class="row d-flex">
                         ...
                         <h5 class="m-3" style="font-family: 'Kanit', sans-serif;">
                            ...
                            <div class="mt-3 mb-3 text-center">
                              <button type="submit" class="btn btn-primary btn-lg" style="font-family: 'Kanit', sans-serif;">ค้นหา</button>
                </form>
                    </div> -->
